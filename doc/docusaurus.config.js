...
const config = {
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: "shortcut icon",
        href: "https://blockroma.com/img/favicon.png",
      },
    },
    {
      tagName: "link",
  ...
  presets: [
    [
      ...
      ({
        docs: {
          editUrl: "https://github.com/cosvmlabs/EVM-Explorer/edit/main",
  ...
  themeConfig:
    ...
    ({
      metadata: [
        {
          name: "keywords",
          content:
            "CVMExplorer, Open-source, EVM-compatible, blockchain explorer",
        },
      ],
      ...
      footer: {
        style: "dark",
        links: [],
        copyright: `Copyright © ${new Date().getFullYear()} CVMExplorer`,
      },
      prism: {
